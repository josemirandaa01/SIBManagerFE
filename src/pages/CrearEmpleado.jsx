...
export default function CrearEmpleado() {
  const [form, setForm] = useState({
    ...
    tipoEmpleadoId: 1, departamentoId: "", estado: true,
    salarioSemanal: "", sueldoPorHora: "", horasTrabajadas: "",
    ventasBrutas: "", tarifaComision: "", salarioBase: ""
  });
  ...
  useEffect(() => {
    api.get("/empleados/departamentos").then(setDeptos).catch(() => {});
  }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError("Error al guardar el empleado. Verifica los datos.");
